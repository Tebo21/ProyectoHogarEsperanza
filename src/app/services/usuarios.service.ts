...
export class UsuarioService {
  ...
  getQueryLogin(query: string, usuarioCedula: string, usuarioContrasenia: string, usuarioTipo: number): Observable<Usuarios> {
    const url = `http://http://ec2-18-222-23-30.us-east-2.compute.amazonaws.com:3000/${query}?usuarioCedula=${usuarioCedula}&usuarioContrasenia=${usuarioContrasenia}&usuarioTipo=${usuarioTipo}`;
  ...
  QueryAddUser(query: String, usuario: Usuarios) {
    const url = `http://http://ec2-18-222-23-30.us-east-2.compute.amazonaws.com:3000/${query}`;
  ...
  getAll(): Observable<any> {
    const url = `http://http://ec2-18-222-23-30.us-east-2.compute.amazonaws.com:3000/getAll-usuario`;
    return this.http.get<Usuarios>(url);
  }

  QueryDeleteUser(query: String, idUsuario: number) {
    const url = `http://http://ec2-18-222-23-30.us-east-2.compute.amazonaws.com:3000/${query}/${idUsuario}`;
  ...
  getQueryUserByCedula(query: string, usuarioCedula: string): Observable<Usuarios> {
    const url = `http://http://ec2-18-222-23-30.us-east-2.compute.amazonaws.com:3000/${query}?usuarioCedula=${usuarioCedula}`;
    return this.http.request<Usuarios>('get', url);
  }
